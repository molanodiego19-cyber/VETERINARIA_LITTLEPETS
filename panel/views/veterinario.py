...
from panel.views.propietario import filtrar_propietarios
...
def reporte_veterinarios_pdf(request):
    ...
    response[
        'Content-Disposition'
    ] = 'attachment; filename="veterinarios.pdf"'
    ...
    veterinarios = filtrar_veterinarios(
        request
    )
...
def reporte_veterinarios_excel(request):
    ...
    response[
        'Content-Disposition'
    ] = 'attachment; filename="veterinarios.xlsx"'
