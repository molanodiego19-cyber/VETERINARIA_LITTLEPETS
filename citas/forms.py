...
class CitaForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if not disponible:
            ...
            raise forms.ValidationError(
                "⚠️ Este horario ya no está disponible"
            )
...
class ConsultaForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'diagnostico_definitivo': forms.Textarea(attrs={
                'class': 'form-control',
                'rows': 3
            }),

            'plan_terapeutico': forms.Textarea(attrs={
                'class': 'form-control',
                'rows': 3
            }),
            ...
            'peso_en_consulta': forms.NumberInput(attrs={
                'class': 'form-control',
                'step': '0.01'
            }),
...
class TratamientoForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if fecha_fin and fecha_fin < hoy:
            ...
            self.add_error(
                'fecha_fin',
                'La fecha final no puede ser pasada.'
            )
...
class HistorialServiciosForm(forms.ModelForm):
