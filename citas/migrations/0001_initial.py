    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('notas_adicionales', models.TextField(blank=True, max_length=200, null=True)),
                ('estado', models.CharField(choices=[('pendiente', 'Pendiente'), ('confirmada', 'Confirmada'), ('cancelada', 'Cancelada'), ('finalizada', 'Finalizada'), ('en_proceso', 'En Proceso')], default='confirmada', max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('peso_en_consulta', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ('temperatura', models.DecimalField(blank=True, decimal_places=1, max_digits=4, null=True, validators=[django.core.validators.MinValueValidator(35), django.core.validators.MaxValueValidator(42)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('archivo_adjunto', models.FileField(blank=True, null=True, upload_to='historia_clinica/')),
                ('fecha_creacion', models.DateTimeField(auto_now_add=True)),
                ('fecha_actualizacion', models.DateTimeField(auto_now=True)),
            ],
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dosis', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
