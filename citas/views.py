...
def historia_clinica_mascota(request, mascota_id):
    ...
    consultas = (
        HistoriaClinica.objects.filter(mascota=mascota, tipo_registro="consulta")
    ...
    vacunaciones = (
        Vacunacion.objects.filter(cita__mascota=mascota)
        .select_related("vacuna", "cita", "cita__veterinario")
